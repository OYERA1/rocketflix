...
export default function Main({ children }: { children: ReactNode }) {
  return (
    <main
      ...
      min-h-screen max-h-full max-w-full px-6 py-3 sm:px-28 
      bg-bkg-primary text-content isolate 
      transition-colors duration-700 ease-in-out
      before:absolute before:h-[200px] before:w-8/12 before:rounded-tr-full 
      before:rounded-bl-full before:blur-[80px] before:bg-gradient-2 
      before:animate-spin-slower before:-z-10
      before:transition-colors before:duration-700 before:ease-in-out
      after:absolute after:h-2/5 sm:after:h-2/3 after:w-1/6 sm:after:w-1/3 
